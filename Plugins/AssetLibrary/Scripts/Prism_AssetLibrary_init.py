...
from Prism_AssetLibrary_Integration import Prism_AssetLibrary_Integration


class Prism_AssetLibrary(Prism_AssetLibrary_Variables, Prism_AssetLibrary_Functions, Prism_AssetLibrary_Integration):
    def __init__(self, core):
        Prism_AssetLibrary_Variables.__init__(self, core, self)
        Prism_AssetLibrary_Functions.__init__(self, core, self)
        Prism_AssetLibrary_Integration.__init__(self, core, self)
